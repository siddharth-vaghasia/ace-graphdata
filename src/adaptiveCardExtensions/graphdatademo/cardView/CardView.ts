...
import { IGraphdatademoAdaptiveCardExtensionProps, IGraphdatademoAdaptiveCardExtensionState, QUICK_VIEW_REGISTRY_ID } from '../GraphdatademoAdaptiveCardExtension';

export class CardView extends BasePrimaryTextCardView<IGraphdatademoAdaptiveCardExtensionProps, IGraphdatademoAdaptiveCardExtensionState> {
